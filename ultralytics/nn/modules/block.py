...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           ...
           , 'C3RFEM', 'ASPP', 'CARAFE', 'SPPFCSPC', 'DiverseBranchBlock', 'C2f_DCN', 'EVCBlock', 'Concat_bifpn')
...
class HGBlock(nn.Module):
    ...
    def __init__(self, c1, cm, c2, k=3, n=6, lightconv=False, shortcut=False, act=nn.SiLU()):
